...
from tools.library_license_checker.license_utils import (rate_license,
                           fetch_license_from_pypi)
from tools.library_license_checker.normalization import normalize_license_text

from tools.library_license_checker.config.license_map import (STANDARD_LIBS,
                                PACKAGE_ALIASES)
